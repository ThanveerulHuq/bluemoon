...
<div class="mtop-50">
		<div class="row">
			<div class="col-md-offset-2 col-md-2 mtop-40">
				<a class="btn btn-info pull-right" href="/SDMS/VanFeeForm">Add Van Route</a>
			</div>
		</div>
...
$('document').ready(function(){
		...
		grid.jqGrid({
		url:'getVanFee',
		colNames:['Edit','Van Route', 'Van Fee'],
		colModel:[
		...
		{name:'fee',index:'fee', width:150,align:"center"}
		],
		...
		function formatEdit (cell,option,row){
			...
			return "<a href='/SDMS/EditVanFee?FeeId="+cell+"' ><span class='glyphicon glyphicon-edit'></span></a>"
		}
