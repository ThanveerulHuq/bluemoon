...
<div id="printArea" class="container">
	<div style="text-align:center;margin:15px;">
		<button id="printButton" class="btn btn-lg btn-default pull-left" onclick="window.location='/SDMS_2021/StudentInfo'" >Go Back</button>
	...
	<c:choose>
    	<c:when test="${not empty PhotoId}">
			<img src="/SDMS_2021/GetFile?docId=${PhotoId}" alt="No Photo Available" width="170" height="230"/>    
		</c:when>
    	<c:otherwise>
        	No Photo Available
    	</c:otherwise>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		if(studentId != ''){
			...
			window.location = "/SDMS_2021/AddStudent";
		}
