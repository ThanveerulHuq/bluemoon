...
function formatEdit (cell,option,row){
	...
	return "<a href='/SDMS_2020/EditStudent?student_id="+cell+"' ><span class='glyphicon glyphicon-edit'></span></a>"
}
function formatPrint (cell,option,row){
	
	return "<a href='/SDMS_2020/PrintStudentInfo?studentId="+cell+"' ><span class='glyphicon glyphicon-print'></span></a>"
}
