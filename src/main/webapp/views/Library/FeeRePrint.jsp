	...
	<div id="printArea" class="container" style="margin-top: 10px">
		...
		<div style="text-align: center; margin: 15px;">
			<button id="printButton" class="btn btn-lg btn-default pull-left"
				onclick="window.location='/SDMS_2021/FeeReport'">Go Back</button>
				...
				<tbody>
					...
					<tr valign="top">
						...
						<td colspan="1" width="10%" style="border: 1px solid">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									><strong>AMOUNT (Rs)</strong></span></span>
							</div>
						</td>
						<td colspan="1" width="15%" style="border: 1px solid">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									><strong>PAID (Rs)</strong></span></span>
							</div>
						</td>
						<td colspan="2" width="35%">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									><strong>BALANCE (Rs)</strong></span></span>
							</div>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<c:forEach var="txn" items="${lastTxns}">
							...
							<td colspan="1" width="20%" style="border: 1px solid">
								<div align="right">
									<span style="font-family: Calibri, sans-serif;"><span
										><strong>CURRENT BALANCE (Rs. ${Print.studentYear.total} - Rs. ${Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee-Print.amountPaid} )</strong></span></span>
								</div>
							</td>
							<td colspan="3" width="50%" valign="middle" style="border: 1px solid">
								<div>
									<span style="font-family: Calibri, sans-serif;"><span
										>Rs. ${Print.studentYear.total + Print.amountPaid -(Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee)}</span></span>
								</div>
							</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						<td colspan="1" style="border: 1px solid">
							<div align="right">
								<span style="font-family: Calibri, sans-serif;"><span
									><strong>NEW BALANCE</strong></span></span>
							</div>
						</td>
						<td colspan="3">
							<div>
								<span style="font-family: Calibri, sans-serif;"><span
									>Rs. ${Print.studentYear.total - ( Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee)}</span></span>
							</div>
						</td>
					</tr>
					<tr valign="top">
