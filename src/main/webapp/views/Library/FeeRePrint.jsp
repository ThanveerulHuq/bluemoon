	...
	<div id="printArea" class="container" style="margin-top: 10px">
		...
		<div style="text-align: center; margin: 15px;">
			<button id="printButton" class="btn btn-lg btn-default pull-left"
				onclick="window.location='/SDMS_2020/FeeReport'">Go Back</button>
				...
				<tbody>
					<tr valign="middle" style="border-bottom: 4px double;">
						<td width="10%" height="63">
							<div>
								<img
									src="<%=request.getContextPath()%>/resources/images/school_logo.png"
						...
						<td colspan="5" width="90%">
							...
							<div align="center">
								<span style="font-family: 'Times New Roman', serif;"><span
									...
									style="font-size: small;">+91 98942 50320 | E-mail: <a>dhaarussalaam1@gmail.com</a> | website: <a>www.dhaarussalaam.in</a></span></span>
							</div>
						</td>
					</tr>
						...
						<td colspan="2">
							<div>
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>DATE: </strong><span
											style="padding: 25px;" class="paymentDate"></span></span></span></span>
							</div>
						</td>
						<td colspan="2">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>ACADEMIC
											YEAR: </strong><span style="padding: 15px;">${Print.studentYear.commonFee.academicYear.year}</span></span></span></span>
							</div>
						</td>
						<td colspan="2">
							<div>
								<span style="font-family: 'Calibri', sans-serif;"><span
									style="font-size: small;"><strong>RECEIPT #</strong>
					...
					<tr valign="top">
						<td colspan="3" width="50%">
							<div align="left">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>STUDENT NAME :</strong><span
						...
						<td colspan="2" >
							<div align="left">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>CLASS:</strong><span
						...
						<td colspan="1" width="30%">
							<div align="left">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>SECTION:</strong><span
					...
					<tr valign="top">
						...
						<td colspan="1" width="10%" style="border: 1px solid">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>AMOUNT (Rs)</strong></span></span>
							</div>
						</td>
						<td colspan="1" width="15%" style="border: 1px solid">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>PAID (Rs)</strong></span></span>
							</div>
						</td>
						<td colspan="2" width="35%">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>BALANCE (Rs)</strong></span></span>
							</div>
						</td>
					</tr>
					<tr valign="top">
						...
						<td colspan="2" width="35%">
							<div align="center">${Print.studentYear.commonFee.schoolFee - (Print.studentYear.paidFee.schoolFee)}</div>
						</td>
					</tr>
					<tr valign="top">
						...
						<td colspan="2" width="35%">
							<div align="center">${Print.studentYear.commonFee.bookFee - (Print.studentYear.paidFee.bookFee)}</div>
						</td>
					</tr>
					<tr valign="top">
						<td colspan="2" width="30%" style="border: 1px solid">
						...
						<td colspan="2" width="35%">
							<div align="center">${Print.studentYear.uniformFee - (Print.studentYear.paidFee.uniformFee)}</div>
						</td>
					</tr>
					<tr valign="top">
						<td colspan="2" width="30%" style="border: 1px solid">
						...
						<td colspan="2" width="35%">
							<div align="center">${Print.studentYear.islamicStudies - (Print.studentYear.paidFee.islamicStudies)}</div>
						</td>
					</tr>
					<tr valign="top">
					...
					<tr valign="top">
						...
						<c:forEach var="txn" items="${lastTxns}">
								<li><span class="date"><c:out value="${txn.paymentDate}" /></span> :
    							Rs. <span><c:out value="${txn.amountPaid}" /></span>
								</li>
						</c:forEach>
						</ul>
							</td>
							<td colspan="1" width="20%" style="border: 1px solid">
								<div align="right">
									<span style="font-family: Calibri, sans-serif;"><span
										style="font-size: small;"><strong>CURRENT BALANCE (Rs. ${Print.studentYear.total} - Rs. ${Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee-Print.amountPaid} )</strong></span></span>
								</div>
							</td>
							<td colspan="3" width="50%" valign="middle" style="border: 1px solid">
								<div>
									<span style="font-family: Calibri, sans-serif;"><span
										style="font-size: small;">Rs. ${Print.studentYear.total + Print.amountPaid -(Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee)}</span></span>
								</div>
							</td>
					</tr>
					<tr valign="top">
						...
						<td colspan="3">
							<div>
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;">Rs. ${Print.amountPaid}</span></span>
							</div>
						</td>
					</tr>
					<tr valign="top">
						<td colspan="1" style="border: 1px solid">
							<div align="right">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>NEW BALANCE</strong></span></span>
							</div>
						</td>
						<td colspan="3">
							<div>
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;">Rs. ${Print.studentYear.total - ( Print.studentYear.paidFee.vanFee + Print.studentYear.paidFee.islamicStudies + Print.studentYear.paidFee.uniformFee + Print.studentYear.paidFee.bookFee + Print.studentYear.paidFee.schoolFee)}</span></span>
							</div>
						</td>
					</tr>
					<tr valign="top">
					...
					<td colspan="1" width="10%" style="border: 1px solid">
							<div align="center">
								<span style="font-family: Calibri, sans-serif;"><span
									style="font-size: small;"><strong>REMARKS:</strong></span></span>
							</div>
						</td>
