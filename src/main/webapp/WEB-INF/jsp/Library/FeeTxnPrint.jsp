                        ...
                        <div id="printArea" class="container" style="margin-top: 10px">
                            ...
                            <div style="text-align: center; margin: 15px;">
                                <button id="printButton" class="btn btn-lg btn-default pull-left"
                                    onclick="window.location='/SDMS/FeeTxn'">Go Back
                                </button>
                                <button id="printButton" class="btn btn-lg btn-info"
                                    onclick="window.print();return false;">Print Receipt
                                </button>
                            </div>
                            <div id='mainReceipt'>
                                    ...
                                    <tbody>
                                        ...
                                        <tr valign="top" style="border-bottom: 1px solid;">
                                            <td width="10%">
                                                <div>
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span><strong>DATE:</strong></span></span>
                                                </div>
                                            </td>
                                            ...
                                            <td colspan="3" width="50%">
                                                <div align="left">
                                                    <span style="font-family: Calibri, sans-serif;"><span>ACADEMIC
                                                            YEAR: <span
                                                                style="padding: 15px;">${Print.studentYear.commonFee.academicYear.year}</span>
                                                        </span></span>
                                                </div>
                                            </td>
                                            ...
                                            <td colspan="3" width="50%">
                                                <div align="left">
                                                    <span style="font-family: Calibri, sans-serif;"><span>STUDENT
                                                            NAME :<span
                                                                style="padding: 15px;">${Print.studentYear.studentsInfo.name}</span>
                                                        </span></span>
                                                </div>
                                            </td>
                                            <td colspan="3" width="50%">&nbsp;</td>
                                        ...
                                        <tr valign="top">
                                            <td colspan="1" width="10%">
                                                <div align="left">
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span>CLASS:</span></span>
                                                </div>
                                            </td>
                                            <td colspan="1" width="10%">
                                                <div align="left">
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span>${Print.studentYear.commonFee.classInfo.className}</span></span>
                                                </div>
                                            </td>
                                        ...
                                        <tr valign="top">
                                            <td rowspan="3" colspan="2" width="30%" style="font-size: 10px;"><span
                                                    style="font-weight: bold;">Payment History: </span>
                                            ...
                                            <td colspan="3" width="50%" style="border: 1px solid">
                                                <div>
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span>${Print.studentYear.total}</span></span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            ...
                                            <td colspan="3">
                                                <div>
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span>${Print.amountPaid}</span></span>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr valign="top">
                                            <td colspan="1" style="border: 1px solid">
                                                <div align="right">
                                                    <span
                                                        style="font-family: Calibri, sans-serif;"><span><strong>BALANCE</strong></span></span>
                                                </div>
                                            </td>
                                            <td colspan="3">
                                                <div>
                                                    <span style="font-family: Calibri, sans-serif;"><span>${Print.studentYear.total
                                        ...
                                        <tr valign="top" style="height: 30px;">
                                            <td colspan="1"  style="border: 1px solid;text-align: center;font-family: Calibri, sans-serif;">
                                                <div>
                                            ...
                                            <td colspan="2">
                                                <div>
                                                    <span style="font-family: Calibri, sans-serif;"><span>
                                                            <span class="remarks">${Print.remarks}</span>
                                                        </span></span>
                                                </div>
                                            </td>
                                        </tr>
