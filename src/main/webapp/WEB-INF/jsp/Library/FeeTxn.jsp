								...
								<%-- </form> --%>
									...
									<div class=" mtop-15" style="display:block">
										<form:form id="saveFeeForm" method="POST" action="/SDMS/SaveFeeTxn"
											modelAttribute="FeeTxn" class="mtop-15" enctype="multipart/form-data">
											<div class="form-group col-md-12"><label class="col-md-2"><span
												...
												<div class="row"><label class="col-md-2"><span
															class="pull-right">Payment Date:</span> </label>
													<div class="col-md-3">

														<form:input path="paymentDate" id="paymentDate"
															name="paymentDate" class="form-control" required='true' />
													</div>
												</div>
											</div>
											<div class="form-group col-md-12">
											...
											<div class="form-group col-md-8 col-md-offset-2">
												<table class="table table-bordered">
													...
													<tr>
														...
														<td>
															<form:input path="schoolFee" id="schoolFee"
													...
													<tr>
														...
														<td>
															<form:input path="bookFee" id="bookFee"
																class="form-control fee-input" type="number"
																required="true" />
														</td>
													</tr>
													<tr>
														...
														<td>
															<form:input path="uniformFee" id="uniformFee"
																class="form-control fee-input" type="number"
																required="true" />
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<form:input path="vanFee" id="vanFee"
																class="form-control fee-input" type="number"
																required="true" />
														</td>
													</tr>
													...
													<tr>
														...
														<td>
															<form:input path="amountPaid" id="tot_paid"
