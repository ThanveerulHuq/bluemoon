				...
				<%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
					...
					<body>
						...
						<section class="container mtop-50">
							...
							<form:form method="POST" action="/SDMS/SaveStudent" modelAttribute="StudentsInfo"
								class="mtop-25" enctype="multipart/form-data">
								...
								<div class="form-group col-md-12">
									...
									<label class="col-md-2"><span class="pull-right">Student
											Name:</span></label>
									<div class="col-md-3">
										<form:input path="name" class="form-control" required="true" type="text"
											maxlength="40" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">Age:</span></label>
										<div class="col-md-3">
											<form:input path="age" class="form-control" type="number" required="true"
												maxlength="2"
								...
								<div class="form-group col-md-12">
									...
									<div class="col-md-3">
										<form:select path="gender" class="form-control" value="${StudentsInfo.gender}">
								...
								<div class="form-group col-md-12">
									<label class="col-md-2"><span class="pull-right">Aadhar
											Number:</span> </label>
									<div class="col-md-3">
										<form:input path="aadharNo" class="form-control" type="number" required="true"
											maxlength="12"
											oninput="javascript: if (this.value.length > this.maxLength) showalert('length should not be more than'+this.maxLength,'error');this.value = this.value.slice(0, this.maxLength);" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">EMIS
												Number:</span> </label>
										<div class="col-md-3">
											<form:input path="emisNo" class="form-control" type="number" required="true"
												maxlength="20"
												oninput="javascript: if (this.value.length > this.maxLength) showalert('length should not be more than'+this.maxLength,'error');this.value = this.value.slice(0, this.maxLength);" />
										</div>
									</div>
								...
								<div class="form-group col-md-12">
									<label class="col-md-2"><span class="pull-right">Admission
											Number:</span> </label>
									<div class="col-md-3">
										<form:input path="admissionNo" name="admissionNo" class="form-control"
											required="true" type="number" maxlength="15" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">Admission
												Date:</span> </label>
										<div class="col-md-3">
											<form:input path="admissionDate" name="admissionDate" class="form-control"
								...
								<div class="form-group col-md-12">
									...
									<div class="col-md-3">
										<form:input path="caste" class="form-control" required="true" type="text"
											maxlength="30" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">Nationality:</span> </label>
										<div class="col-md-3">
											<form:input path="nationality" class="form-control" type="text"
								...
								<div class="form-group col-md-12">
									<label class="col-md-2"><span class="pull-right">Father
											Name:</span> </label>
									<div class="col-md-3">
										<form:input path="fatherName" class="form-control" required="true" type="text"
											maxlength="40" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">Mother
												Name:</span> </label>
										<div class="col-md-3">
											<form:input path="motherName" class="form-control" type="text"
								...
								<div class="form-group col-md-12">
									<label class="col-md-2"><span class="pull-right">Previous
											School:</span> </label>
									<div class="col-md-3">
										<form:input path="previousSchool" type="text" maxlength="100"
											class="form-control" />
									</div>
									<div class="row">
										<label class="col-md-2"><span class="pull-right">Mother
												Tongue:</span> </label>
										<div class="col-md-3">
											<form:input path="motherTongue" class="form-control" type="text"
								...
								<div class="form-group col-md-12">
									<label class="col-md-2"><span class="pull-right">Active
											Status:</span> </label>
									<div class="col-md-3">
										<form:select path="active" name="active" class="form-control" id="active"
										...
										<div class="form-group col-md-12">
											...
											<div class="col-md-1">
												<button class="btn btn-info"
													onclick="getFile('${StudentsInfo.fileIds[status.index]}')">Download</button>
											</div>
											<div class="col-md-1 mleft-10">
												<button class="btn btn-danger pull-left"
													onclick="removeMe(this,'${StudentsInfo.fileIds[status.index]}')">Remove</button>
											</div>
										</div>
									</c:forEach>
								</div>
							...
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<button type="button" class="close closeStream"
									...
									<div class="modal-footer">
										<button type="button" class="btn btn-default closeStream"
