			...
			<%@ taglib uri="http://java.sun.com/jsp/jstl/functions" prefix="fn" %>
				...
				<body>
					...
					<div class="mtop-50">
						...
						<form:form method="POST" action="/SDMS/SetFee" modelAttribute="CommonFee" class="mtop-15"
							...
							<div class="form-group col-md-12">
								...
								<div class="col-md-3">
									...
									<select class="form-control" id="classId" path="classInfo.classId"
							...
							<div class="col-md-7">
								<div class="pull-right">
									<form:button type="button" class="btn btn-danger btn-md" onclick="clearInput()">
										Reset</form:button>
									<form:button type="submit" class="btn btn-success" onclick="validateForm()">Submit
									</form:button>
								</div>
							</div>
						</form:form>
