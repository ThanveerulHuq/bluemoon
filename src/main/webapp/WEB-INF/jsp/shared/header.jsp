...
<header>
       <nav class="navbar navbar-expand-lg navbar-light text-light main-nav">
          <div class="container" style="width:1330px!important;">
            <a class="navbar-brand padding-0" href="/SDMS/Home"><img src="<%=request.getContextPath()%>/images/scool_logo.png" width="45" alt="Logo"></a>
              <!-- <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
              </button> -->
				  <a href="/SDMS/Home"><h3 class="col-md-5" style="color:white;width:38%;">DHAARUS SALAAM STUDENTS DATABASE</h3></a>
...
<!--                   </li> -->
                  <li class="nav-tab">
                    <a class="nav-link text-uppercase" href="/SDMS/Logout"><img src="<%=request.getContextPath()%>/images/logout.png" width="25" alt="Logout"></a>
                  </li>
                </ul>
              </div>
          </div>
