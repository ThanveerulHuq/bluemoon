...
<!-- 		</div> -->
		...
		<form:form method="POST" action="/SDMS_2022/MapStudent"
		modelAttribute="StudentsYear" class="mtop-15"
...
// 		$.ajax({
// 		url: '/SDMS_2022/getStudentInfoByAdNo?admissionNo='+admissionNo,
// 		method: 'GET',
...
// 	}
	function getFee(){
		...
		$.ajax({
			url: '/SDMS_2022/getCommonFeeByClass?classId='+classId+'&academicYearId='+academicYearId,
			method: 'GET',
			success: function(res){
				console.log(res);
			if(res.id != undefined){
	...
	$('.feeinput,#scholorship').change(function(){
		...
		function checkUnique(id,year){
			$.ajax({
				url: '/SDMS_2022/CheckStdFrUnique?academicYear='+year+'&&studentId='+id,
				method: 'GET',
				success: function(res){
				if(res == "exist"){
...
// 			$.ajax({
// 				url: '/SDMS_2022/CheckStdFrUnique?academicYear='+academicYr+'&&admissionNo='+admissionNo,
// 				method: 'GET',
// 				success: function(res){
// 				if(res == "exist"){
// 				$('#btn_submit').attr('disabled','true');
