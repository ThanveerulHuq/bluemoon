...
import com.sdms.bluemoon.entity.*;
import com.sdms.bluemoon.model.StudentYearModel;
import com.sdms.bluemoon.repository.*;
...
public class StudentYearController {
    ...
    public String editStudentYear(HttpServletRequest request,
        ...
        StudentYear studentYear = studentYearRepo.findById(studentYrId).get();
    ...
    public String MapStudent(
        ...
        StudentsInfo studentsInfo = studentsInfoRepo.findById(studentYearModel.getStudentId()).get();
        CommonFee commonFee = commonFeeRepo.findById(studentYearModel.getFeeId()).get();
        ...
        if (newStudentYrId != null) {
            StudentYear oldStudentYr = studentYearRepo.findById(newStudentYrId).get();
    ...
    private Long getTotal(StudentYearModel studentYearModel, Long schoolFee, Long BookFee) {
        ...
        Long total = schoolFee + BookFee + studentYearModel.getVan_fee() + studentYearModel.getUniform_fee() - studentYearModel.getScholorship();
        return total;
    }
    ...
    public StudentsInfo getStudentbyId(HttpServletRequest request, HttpServletResponse response, @ModelAttribute("id") Long id) throws IOException {
        return studentsInfoRepo.findById(id).get();
    }
